          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-bolt-elements-background-depth-2 hover:bg-bolt-elements-background-depth-3 border-bolt-elements-borderColor hover:border-red-500/30 transition-all duration-200 gap-2 text-red-500"
              >
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-bolt-elements-textSecondary mb-4">
                          ...
                          <a
                            ...
                            className="text-red-500 hover:underline inline-flex items-center gap-1 font-medium"
                          >
                            ollama.com/library
