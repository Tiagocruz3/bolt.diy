...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with Brainiac IDE
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('Brainiac IDE - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by Brainiac IDE', margin, doc.internal.pageSize.getHeight() - 10);
