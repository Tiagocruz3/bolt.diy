...
export function UserMessage({ content, parts }: UserMessageProps) {
      ...
      <div className="overflow-hidden flex flex-col gap-3 items-center ">
        <div className="flex flex-row items-start justify-center overflow-hidden shrink-0 self-start">
          {profile?.avatar || profile?.username ? (
            ...
            <div className="i-ph:user-fill text-red-500 text-2xl" />
          )}
        </div>
        <div className="flex flex-col gap-4 bg-red-500/10 backdrop-blur-sm p-3 py-3 w-auto rounded-lg mr-auto">
  ...
  return (
    <div className="flex flex-col bg-red-500/10 backdrop-blur-sm px-5 p-3.5 w-auto rounded-lg ml-auto">
